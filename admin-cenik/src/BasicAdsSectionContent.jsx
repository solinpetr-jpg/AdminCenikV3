...
import { basicAdsServices } from './data/basicAdsServices.js'
...
function BasicAdRow({ service, quantity, setQuantity, index }) {
  ...
  return (
    ...
    >
      <div
        className={`premium-service-row premium-service-row--grid py-3 px-3 ${
      ...
      {/* Pravý blok: grid – discount-label vždy na stejném X jako „Sleva 20%“ */}
