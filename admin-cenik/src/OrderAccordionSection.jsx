...
const categoryIconProps = { size: 20, color: '#1B3C98' }
...
export default function OrderAccordionSection({
  ...
  return (
    <div className={`order-accordion-section rounded overflow-hidden shadow-sm ${expanded ? 'order-accordion-section--open' : ''}`}>
      <button
        type="button"
      ...
      >
        ...
        <div className="d-flex align-items-center gap-2">
          <span className="premium-section-summary">{itemCount} {pluralPoložka(itemCount)}</span>
